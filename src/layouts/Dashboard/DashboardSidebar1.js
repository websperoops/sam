  ...
  return (
    <Box sx={{ display: 'flex',width:'100%'  }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar className={open ? classes.topbarclose  : classes.topbaropen}>
          <IconButton
            color="inherit"
      ...
      <Drawer variant="permanent" open={open}>
        <DrawerHeader>
        {/* <img src={mainlogo} alt="Real Estate" height="50px" width="100px" />  */}
        ...
        <NavSection navConfig={SidebarConfig} open={open} />
        <Divider />
      </Drawer>
